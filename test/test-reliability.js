...
(async () => {
  ...
  if (globalThis.console && globalThis.console.warn) globalThis.console.warn(
  ...
  if (globalThis.console && globalThis.console.log) globalThis.console.log("Reliability DLQ test passed. Processed", replay.processed);
})().catch((e) => {
  if (globalThis.console && globalThis.console.error) globalThis.console.error("Reliability test failed:", e);
